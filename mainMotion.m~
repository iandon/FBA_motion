...
% dateTime=(c(3:13));
% 
% direc = sprintf('%s/results/%s/%s/ses%d', homedir,params.saveVars.expTypeDirName,initials,sesNum); 
% saveExpFile = sprintf('%s_%s_ses%s_%s.mat', expParams, initials, sesNum, dateTime);
