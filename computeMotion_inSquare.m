...
dxdy_dirc 	= repmat(params.stim.speedDegPerMsec * (1/params.screenVar.monRefresh) * [cos(pi*trialAngle/180.0) sin(pi*trialAngle/180.0)], params.dots.num,1);

% Compute motion direction for NON coherent motion (random directions)
randDirc = randi(360,params.dots.num,1); 
dxdy_rand 	= (params.stim.speedDegPerMsec * (1/params.screenVar.monRefresh) * [cos(pi*randDirc/180.0) sin(pi*randDirc/180.0)]);
